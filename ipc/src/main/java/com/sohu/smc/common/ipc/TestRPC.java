...
package com.sohu.smc.common.ipc;
...
public class TestRPC {
  ...
  public static final Logger LOG =
    LogFormatter.getLogger("com.sohu.smc.common.ipc.TestRPC");
  ...
  public interface TestProtocol {
    void ping(String query) throws Exception;
  ...
  public class TestImpl implements TestProtocol {
    ...
    public void ping(String query)throws Exception {}
