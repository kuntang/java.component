...
import com.sohu.smc.common.leveldb.local.RawTableRow;
import com.sohu.smc.common.leveldb.local.TableIterator;
import com.sohu.smc.common.leveldb.local.TableRow;
import com.sohu.smc.common.leveldb.sede.Serde;
import com.sohu.smc.common.leveldb.util.Util;

public class LocalLevelDbTable<H, R, V> implements RangeTable<H, R, V> {
  private final DB db;
  ...
  public LocalLevelDbTable(File path, LocalLevelDbFactory factory, Serde<H> hashKeySerde, Serde<R> rangeKeySerde,
    ...
    options.comparator(new LocalLevelDbComparator(hashKeyComparator, rangeKeyComparator));
