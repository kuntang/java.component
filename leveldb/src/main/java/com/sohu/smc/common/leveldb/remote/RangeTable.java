...
public interface RangeTable<H, R, V> extends Table<H, V> {
   ...
   */
  public TableIterator<H, R, V> range(H hashKey, R fromRangeKey, R toRangeKey, int limit);
   ...
   *         their range key.
   */
  public TableIterator<H, R, V> rangeReverse(H hashKey, int limit);
   ...
   */
  public TableIterator<H, R, V> rangeReverse(H hashKey, R fromRangeKey, int limit);
   ...
   *         have a range key [fromRangeKey, toRangeKey).
   */
  public TableIterator<H, R, V> rangeReverse(H hashKey, R fromRangeKey, R toRangeKey, int limit);
