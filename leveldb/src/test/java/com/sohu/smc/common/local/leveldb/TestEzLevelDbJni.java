...
//import com.sohu.smc.common.leveldb.local.leveldb.LocalLevelDbJniFactory;
...
//import com.sohu.smc.common.leveldb.sede.SerializingSerde;
//
//public class TestEzLevelDbJni extends TestEzLevelDb {
//  @Before
//  public void before() {
//    ezdb = new LocalLevelDb(new File("/tmp"), new LocalLevelDbJniFactory());
