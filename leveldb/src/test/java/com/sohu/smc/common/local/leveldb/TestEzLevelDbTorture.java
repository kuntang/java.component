...
//
//import com.sohu.smc.common.leveldb.local.leveldb.LocalLevelDb;
...
//import com.sohu.smc.common.leveldb.local.TreeMapTable;
//
///**
...
//  @Before
//  public void before() {
//    db = new LocalLevelDb(new File("/tmp"));
//  }
//
//  @Test
...
//      RangeTable<Integer, Integer, Integer> mockTable = new TreeMapTable<Integer, Integer, Integer>(IntegerSerde.get, IntegerSerde.get, IntegerSerde.get, LexicographicalComparator2.get, LexicographicalComparator2.get);
